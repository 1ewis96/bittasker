  ...
  const connectMetaMask = async () => {
    ...
    try {
      if (window.ethereum) {
        ...
        const { tokens } = await verifyResponse.json(); // Handle the returned tokens

        console.log("Tokens:", tokens); // Handle your tokens (ID token, access token)
        // You can store tokens here (e.g., in localStorage or state)
      } else {
